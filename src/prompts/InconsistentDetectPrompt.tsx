...
const InconsistentDetectPrompt = ({fileId, toggleNormalized, toggleImportSuccess, toggleInconsistentDetect, reset, workbook, sheets, vsheets, sheetdata, inclist, updateSData}: IncProps) => {  
